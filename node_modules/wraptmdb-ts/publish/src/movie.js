...
class Movie {
   ...
   ********************/
  async GetDetails(movie_id, language) {
  ...
  /********************
     ...
     ********************/
  async GetAccountStates(movie_id, session_id, guest_session_id) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetAlternativetitles(movie_id, country) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetChanges(movie_id, start_date, end_date, page) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetCredits(movie_id, language) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetImages(movie_id, language, include_image_language) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetLists(movie_id, language, page) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetRecommendations(movie_id, language, page) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
  ...
  /********************
     ...
     ********************/
  async GetReleaseDates(movie_id) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    const targetURL =
      baseURL +
   ...
   ********************/
  async GetReviews(movie_id, language, page) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetSimilar(movie_id, language, page) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetTranslations(movie_id) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    const targetURL =
      baseURL +
   ...
   ********************/
  async GetVideos(movie_id, language) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
  ...
  /********************
     ...
     ********************/
  async GetWatchProviders(movie_id) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    const targetURL =
      baseURL +
   ...
   * }
   ********************/
  async PostRateMovie(movie_id, query, session_id, guest_session_id) {
    const token = c_module.GetToken();
    let targetURL =
      baseURL +
      c_module.Route.MOVIE +
   ...
   ********************/
  async DeleteRating(movie_id, session_id, guest_session_id) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    const baseURL = c_module.GetURL();
    let targetURL =
   ...
   * @doc https://developers.themoviedb.org/3/movies/get-latest-movie
   ********************/
  async GetNowPlaying(language, page, region) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    const baseURL = c_module.GetURL();
    let targetURL =
   ...
   ********************/
  async GetPopular(language, page, region) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    const baseURL = c_module.GetURL();
    let targetURL =
   ...
   ********************/
  async GetTopRated(language, page, region) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    const baseURL = c_module.GetURL();
    let targetURL =
   ...
   ********************/
  async GetUpcoming(language, page, region) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    const baseURL = c_module.GetURL();
    let targetURL =
