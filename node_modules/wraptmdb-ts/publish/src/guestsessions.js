...
class GuestSessions {
     ...
     ********************/
    async GetRatedMovies(guest_session_id, language, sort_by) {
     ...
     ********************/
    async GetRatedTVShows(guest_session_id, language, sort_by) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL +
            c_module.Route.GUESTSESSION +
     ...
     * @doc https://developers.themoviedb.org/3/guest-sessions/get-guest-session-rated-tv-shows
     ********************/
    async GetRatedTVEpisodes(guest_session_id, language, sort_by) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL +
            c_module.Route.GUESTSESSION +
