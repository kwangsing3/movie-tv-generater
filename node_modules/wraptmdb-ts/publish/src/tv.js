...
class TV {
     ...
     ********************/
    async GetDetails(tv_id, language) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL + c_module.Route.TV + tv_id + `?api_key=${token}`;
     ...
     ********************/
    async GetAccountStates(tv_id, session_id, guest_session_id) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
     ...
     ********************/
    async GetAggregateCredits(tv_id, language) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL +
            c_module.Route.TV +
     ...
     ********************/
    async GetAlternativetitles(tv_id, language) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL +
            c_module.Route.TV +
     ...
     ********************/
    async GetChanges(tv_id, start_date, end_date, page) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL + c_module.Route.TV + tv_id + '/changes' + `?api_key=${token}`;
     ...
     ********************/
    async GetContentRatings(tv_id, language) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL +
            c_module.Route.TV +
     ...
     ********************/
    async GetCredits(tv_id, language) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL + c_module.Route.TV + tv_id + '/credits' + `?api_key=${token}`;
        if (language !== undefined) {
            targetURL += `&language=${language}`;
        }
        if (token === 'UnitTest_api_key') {
     ...
     ********************/
    async GetEpisodeGroup(tv_id, language) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL +
            c_module.Route.TV +
     ...
     ********************/
    async GetExternalIDs(tv_id, language) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL +
            c_module.Route.TV +
     ...
     ********************/
    async GetImages(tv_id, language) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL + c_module.Route.TV + tv_id + '/images' + `?api_key=${token}`;
        if (language !== undefined) {
            targetURL += `&language=${language}`;
        }
        if (token === 'UnitTest_api_key') {
     ...
     ********************/
    async GetKeywords(tv_id) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        const targetURL = baseURL + c_module.Route.TV + tv_id + '/keywords' + `?api_key=${token}`;
        if (token === 'UnitTest_api_key') {
            return targetURL;
        }
        const data = await axios.get(targetURL, header);
     ...
     ********************/
    async GetRecommendations(tv_id, language, page) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL +
            c_module.Route.TV +
     ...
     ********************/
    async GetReviews(tv_id, language, page) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL + c_module.Route.TV + tv_id + '/reviews' + `?api_key=${token}`;
        if (language !== undefined) {
            targetURL += `&language=${language}`;
        }
        if (page !== undefined) {
     ...
     ********************/
    async GetScreenedTheatrically(tv_id) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
     ...
     ********************/
    async GetSimilarTVShows(tv_id, language, page) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL + c_module.Route.TV + tv_id + '/similar' + `?api_key=${token}`;
        if (language !== undefined) {
            targetURL += `&language=${language}`;
        }
        if (page !== undefined) {
     ...
     ********************/
    async GetVideos(tv_id, language) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL + c_module.Route.TV + tv_id + '/videos' + `?api_key=${token}`;
        if (language !== undefined) {
            targetURL += `&language=${language}`;
        }
        if (token === 'UnitTest_api_key') {
     ...
     * }
     ********************/
    async PostRateTVShow(tv_id, query, session_id, guest_session_id) {
        const token = c_module.GetToken();
        let targetURL = baseURL + c_module.Route.TV + tv_id + '/rating' + `?api_key=${token}`;
        if (session_id !== '' && session_id !== undefined)
            targetURL += `&session_id=${session_id}`;
        if (guest_session_id !== '' && guest_session_id !== undefined)
            targetURL += `&guest_session_id=${guest_session_id}`;
     ...
     ********************/
    async DeleteRating(tv_id, session_id, guest_session_id) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        const baseURL = c_module.GetURL();
        let targetURL = baseURL + c_module.Route.TV + tv_id + '/rating' + `?api_key=${token}`;
     ...
     ********************/
    async GetLatest(language) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL + c_module.Route.TV + 'latest' + `?api_key=${token}`;
        if (language !== undefined) {
            targetURL += `&language=${language}`;
        }
        if (token === 'UnitTest_api_key') {
     ...
     ********************/
    async GetTVAiringToday(language, page) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL + c_module.Route.TV + 'airing_today' + `?api_key=${token}`;
        if (language !== undefined) {
            targetURL += `&language=${language}`;
        }
        if (page !== undefined) {
     ...
     ********************/
    async GetTVOnTheAir(language, page) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL + c_module.Route.TV + 'on_the_air' + `?api_key=${token}`;
        if (language !== undefined) {
            targetURL += `&language=${language}`;
        }
        if (page !== undefined) {
     ...
     ********************/
    async GetPopular(language, page) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL + c_module.Route.TV + 'popular' + `?api_key=${token}`;
        if (language !== undefined) {
            targetURL += `&language=${language}`;
        }
        if (page !== undefined) {
     ...
     ********************/
    async GetTopRated(language, page) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL + c_module.Route.TV + 'top_rated' + `?api_key=${token}`;
        if (language !== undefined) {
            targetURL += `&language=${language}`;
        }
        if (page !== undefined) {
