 ...
 *
 */
const movie_module = require('./movie');
const tv_module = require('./tv');
const ac_module = require('./account');
const c_module = require('./common');
const authentication_module = require('./authentication');
const certifications_module = require('./certifications');
const changes_module = require('./changes');
const collections_module = require('./collections');
const companies_module = require('./companies');
const configuration_module = require('./configuration');
const credits_module = require('./credits');
const discover_module = require('./discover');
const find_module = require('./find');
const genres_module = require('./genres');
const guestsessions_module = require('./guestsessions');
const keywords_module = require('./keywords');
const lists_module = require('./lists');
const networks_module = require('./networks');
const people_module = require('./people');
const reviews_module = require('./reviews');
const search_module = require('./search');
const trending_module = require('./trending');
const tvepisodesgroups_module = require('./tvepisodesgroups');
const tvepisodes_module = require('./tvepisodes');
const tvseasons_module = require('./tvseasons');
const watchproviders_module = require('./watchproviders');
//#region
...
(function (Movies) {
   ...
   ********************/
  function GetDetails(movie_id, language) {
   ...
   ********************/
  function GetAccountStates(movie_id, session_id, guest_session_id) {
  ...
  Movies.GetAccountStates = GetAccountStates;
  /********************
   ...
   ********************/
  function GetAlternativetitles(movie_id, country) {
    return Validator.MOVIEGetAlternativetitles(movie_id, country);
  }
  Movies.GetAlternativetitles = GetAlternativetitles;
  /********************
   ...
   ********************/
  function GetChanges(movie_id, start_date, end_date, page) {
    return Validator.MOVIEGetChanges(movie_id, start_date, end_date, page);
  }
  Movies.GetChanges = GetChanges;
  /********************
   ...
   ********************/
  function GetCredits(movie_id, language) {
    return Validator.MOVIEGetCredits(movie_id, language);
  }
  Movies.GetCredits = GetCredits;
  /********************
   ...
   ********************/
  function GetExternalIDs(movie_id) {
    return Validator.MOVIEGetExternalIDs(movie_id);
  }
  Movies.GetExternalIDs = GetExternalIDs;
  /********************
  ...
  /********************
     ...
     ********************/
  function GetReleaseDates(movie_id) {
    return Validator.MOVIEGetReleaseDates(movie_id);
  }
  Movies.GetReleaseDates = GetReleaseDates;
  /********************
   ...
   ********************/
  function GetReviews(movie_id, language, page) {
    return Validator.MOVIEGetReviews(movie_id, language, page);
  }
  Movies.GetReviews = GetReviews;
  /********************
   ...
   ********************/
  function GetSimilar(movie_id, language, page) {
    return Validator.MOVIEGetSimilar(movie_id, language, page);
  }
  Movies.GetSimilar = GetSimilar;
  /********************
  ...
  Movies.GetTranslations = GetTranslations;
  /********************
   ...
   ********************/
  function GetVideos(movie_id, language) {
    return Validator.MOVIEGetVideos(movie_id, language);
  }
  Movies.GetVideos = GetVideos;
  /********************
  ...
  Movies.GetWatchProviders = GetWatchProviders;
  /********************
   *17.Rate a movie.
   ...
   * }
   ********************/
  function PostRateMovie(movie_id, query) {
    return Validator.MOVIEPostRateMovie(movie_id, query);
  }
  Movies.PostRateMovie = PostRateMovie;
  /********************
   ...
   *
   ********************/
  function DeleteRating(movie_id, session_id, guest_session_id) {
    return Validator.DeleteRating(movie_id, session_id, guest_session_id);
  }
  Movies.DeleteRating = DeleteRating;
  /********************
   * 19.GET /movie/latest
   ...
   ********************/
  function GetLatest(language) {
    return Validator.MOVIEGetLatest(language);
  }
  Movies.GetLatest = GetLatest;
  /********************
   ...
   * @doc https://developers.themoviedb.org/3/movies/get-latest-movie
   ********************/
  function GetNowPlaying(language, page, region) {
    return Validator.MOVIEGetNowPlaying(language, page, region);
  }
  Movies.GetNowPlaying = GetNowPlaying;
  /********************
   ...
   ********************/
  function GetPopular(language, page, region) {
    return Validator.MOVIEGetPopular(language, page, region);
  }
  Movies.GetPopular = GetPopular;
  /********************
   ...
   ********************/
  function GetTopRated(language, page, region) {
    return Validator.MOVIEGetTopRated(language, page, region);
  }
  Movies.GetTopRated = GetTopRated;
  /********************
   ...
   ********************/
  function GetUpcoming(language, page, region) {
    return Validator.MOVIEGetUpcoming(language, page, region);
  }
  Movies.GetUpcoming = GetUpcoming;
...
(function (TV) {
   ...
   ********************/
  function GetDetails(tv_id, language) {
    return Validator.TVGetDetails(tv_id, language);
  }
  TV.GetDetails = GetDetails;
  /********************
     * 2.Grab the following account states for a session:
        ‧TV show rating
        ‧If it belongs to your watchlist
     ...
     ********************/
  function GetAccountStates(tv_id, session_id, guest_session_id) {
    return Validator.TVGetAccountStates(tv_id, session_id, guest_session_id);
  }
  TV.GetAccountStates = GetAccountStates;
  /********************
   ...
   ********************/
  function GetAggregateCredits(tv_id, language) {
    return Validator.TVGetAggregateCredits(tv_id, language);
  }
  TV.GetAggregateCredits = GetAggregateCredits;
  /********************
   ...
   ********************/
  function GetAlternativetitles(tv_id, language) {
    return Validator.TVGetAlternativetitles(tv_id, language);
  }
  TV.GetAlternativetitles = GetAlternativetitles;
  /********************
   ...
   ********************/
  function GetChanges(tv_id, start_date, end_date, page) {
    return Validator.TVGetChanges(tv_id, start_date, end_date, page);
  }
  TV.GetChanges = GetChanges;
  /********************
   ...
   ********************/
  function GetContentRatings(tv_id, language) {
    return Validator.TVGetContentRatings(tv_id, language);
  }
  TV.GetContentRatings = GetContentRatings;
  /********************
   ...
   * @doc https://developers.themoviedb.org/3/movies/get-movie-changes
   ********************/
  function GetCredits(tv_id, language) {
    return Validator.TVGetCredits(tv_id, language);
  }
  TV.GetCredits = GetCredits;
  /********************
   ...
   ********************/
  function GetEpisodeGroup(tv_id, language) {
    return Validator.TVGetEpisodeGroup(tv_id, language);
  }
  TV.GetEpisodeGroup = GetEpisodeGroup;
  /********************
   ...
   ********************/
  function GetExternalIDs(tv_id, language) {
    return Validator.TVGetExternalIDs(tv_id, language);
  }
  TV.GetExternalIDs = GetExternalIDs;
  /********************
   ...
   ********************/
  function GetRecommendations(tv_id, language, page) {
    return Validator.TVGetRecommendations(tv_id, language, page);
  }
  TV.GetRecommendations = GetRecommendations;
  /********************
   ...
   ********************/
  function GetReviews(tv_id, language, page) {
    return Validator.TVGetReviews(tv_id, language, page);
  }
  TV.GetReviews = GetReviews;
  /********************
   ...
   ********************/
  function GetScreenedTheatrically(tv_id) {
    return Validator.TVGetScreenedTheatrically(tv_id);
  }
  TV.GetScreenedTheatrically = GetScreenedTheatrically;
  /********************
   ...
   ********************/
  function GetVideos(tv_id, language) {
    return Validator.TVGetVideos(tv_id, language);
  }
  TV.GetVideos = GetVideos;
  /********************
      ...
      * @doc https://developers.themoviedb.org/3/movies/get-movie-watch-providers
      ********************/
  function GetWatchProviders(tv_id) {
    return Validator.TVGetWatchProviders(tv_id);
  }
  TV.GetWatchProviders = GetWatchProviders;
  /********************
   *19.Rate a TV show.
   * A valid session or guest session ID is required.
   * @param {number|string} tv_id  tv ID in TMDB
   ...
   * }
   ********************/
  function PostRateTVShow(tv_id, query, session_id, guest_session_id) {
  ...
  TV.PostRateTVShow = PostRateTVShow;
  /********************
   ...
   ********************/
  function DeleteRating(tv_id, session_id, guest_session_id) {
    return Validator.TVDeleteRating(tv_id, session_id, guest_session_id);
  }
  TV.DeleteRating = DeleteRating;
  /********************
   ...
   ********************/
  function GetTVAiringToday(language, page) {
    return Validator.TVGetTVAiringToday(language, page);
  }
  TV.GetTVAiringToday = GetTVAiringToday;
  /********************
   ...
   ********************/
  function GetTVOnTheAir(language, page) {
    return Validator.TVGetTVOnTheAir(language, page);
  }
  TV.GetTVOnTheAir = GetTVOnTheAir;
  /********************
   ...
   ********************/
  function GetPopular(language, page) {
    return Validator.TVGetPopular(language, page);
  }
  TV.GetPopular = GetPopular;
  /********************
   ...
   ********************/
  function GetTopRated(language, page) {
    return Validator.TVGetTopRated(language, page);
  }
  TV.GetTopRated = GetTopRated;
...
(function (Account) {
   ...
   ********************/
  function GetCreatedLists(account_id, session_id, language, page) {
  ...
  Account.GetCreatedLists = GetCreatedLists;
  /********************
   ...
   ********************/
  function GetFavoriteMovies(account_id, session_id, language, sort_by, page) {
  ...
  Account.GetFavoriteMovies = GetFavoriteMovies;
  /********************
   ...
   ********************/
  function GetFavoriteTVShows(account_id, session_id, language, sort_by, page) {
  ...
  Account.GetFavoriteTVShows = GetFavoriteTVShows;
  /********************
   ...
   ********************/
  function PostMarkAsFavorite(query, account_id, session_id) {
    return Validator.ACCOUNTPostMarkAsFavorite(query, account_id, session_id);
  }
  Account.PostMarkAsFavorite = PostMarkAsFavorite;
  /********************
   ...
   ********************/
  function GetRatedMovies(account_id, session_id, language, sort_by, page) {
  ...
  Account.GetRatedMovies = GetRatedMovies;
  /********************
   ...
   ********************/
  function GetRatedTVShows(account_id, session_id, language, sort_by, page) {
  ...
  Account.GetRatedTVShows = GetRatedTVShows;
  /********************
   ...
   ********************/
  function GetRatedTVEpisodes(account_id, session_id, language, sort_by, page) {
  ...
  Account.GetRatedTVEpisodes = GetRatedTVEpisodes;
  /********************
   ...
   ********************/
  function GetMovieWatchlist(account_id, session_id, language, sort_by, page) {
  ...
  Account.GetMovieWatchlist = GetMovieWatchlist;
  /********************
   ...
   ********************/
  function GetTVShowWatchlist(account_id, session_id, language, sort_by, page) {
  ...
  Account.GetTVShowWatchlist = GetTVShowWatchlist;
  /********************
   ...
   ********************/
  function PostAddToWatchlist(session_id, query, account_id) {
    return Validator.ACCOUNTPostAddToWatchlist(session_id, query, account_id);
  }
  Account.PostAddToWatchlist = PostAddToWatchlist;
...
(function (Authentication) {
   ...
   ********************/
  function GetCreateGuestSession() {
    return Validator.AUTHENTICATIONGetCreateGuestSession();
  }
  Authentication.GetCreateGuestSession = GetCreateGuestSession;
  /********************
   ...
   ********************/
  function GetCreateRequestToken() {
    return Validator.AUTHENTICATIONGetCreateRequestToken();
  }
  Authentication.GetCreateRequestToken = GetCreateRequestToken;
  /********************
   ...
   ********************/
  function PostCreateSession(query) {
    return Validator.AUTHENTICATIONPostCreateSession(query);
  }
  Authentication.PostCreateSession = PostCreateSession;
  /********************
   ...
   ********************/
  function PostCreateSessionWithLogin(query) {
    return Validator.AUTHENTICATIONPostCreateSessionWithLogin(query);
  }
  Authentication.PostCreateSessionWithLogin = PostCreateSessionWithLogin;
  /********************
   ...
   * @doc https://developers.themoviedb.org/3/account/get-account-details
   ********************/
  function DeleteDeleteSession(query) {
    return Validator.AUTHENTICATIONDeleteDeleteSession(query);
  }
  Authentication.DeleteDeleteSession = DeleteDeleteSession;
...
(function (Certifications) {
   ...
   ********************/
  function GetMovieCertifications() {
    return Validator.CERTIFICATIONSGetMovieCertifications();
  }
  Certifications.GetMovieCertifications = GetMovieCertifications;
  /********************
   * 2.Get your account details.
   * @returns {any} JSON
   * @doc https://developers.themoviedb.org/3/account/get-account-details
   ********************/
  function GetTVCertifications() {
    return Validator.CERTIFICATIONSGetTVCertifications();
  }
  Certifications.GetTVCertifications = GetTVCertifications;
})((Certifications = exports.Certifications || (exports.Certifications = {})));
let Changes;
(function (Changes) {
  /********************
   ...
   ********************/
  function GetMovieChangeList(start_date, end_date, page) {
    return Validator.CHANGESGetMovieChangeList(start_date, end_date, page);
  }
  Changes.GetMovieChangeList = GetMovieChangeList;
  /********************
   ...
   * @doc https://developers.themoviedb.org/3/changes/get-person-change-list
   ********************/
  function GetTVChangeList(start_date, end_date, page) {
    return Validator.CHANGESGetTVChangeList(start_date, end_date, page);
  }
  Changes.GetTVChangeList = GetTVChangeList;
  /********************
   ...
   * @doc https://developers.themoviedb.org/3/changes/get-person-change-list
   ********************/
  function GetPersonChangeList(start_date, end_date, page) {
    return Validator.CHANGESGetPersonChangeList(start_date, end_date, page);
  }
  Changes.GetPersonChangeList = GetPersonChangeList;
...
(function (Collections) {
   ...
   ********************/
  function GetDetails(collection_id, language) {
    return Validator.COLLECTIONSGetDetails(collection_id, language);
  }
  Collections.GetDetails = GetDetails;
  /********************
   ...
   ********************/
  function GetImages(collection_id, language) {
    return Validator.COLLECTIONSGetImages(collection_id, language);
  }
  Collections.GetImages = GetImages;
  /********************
   ...
   ********************/
  function GetTranslations(collection_id, language) {
    return Validator.COLLECTIONSGetTranslations(collection_id, language);
  }
  Collections.GetTranslations = GetTranslations;
...
(function (Companies) {
  ...
  Companies.GetDetails = GetDetails;
  /********************
   ...
   * @doc https://developers.themoviedb.org/3/companies/get-company-details
   ********************/
  function GetAlternativeNames(company_id) {
    return Validator.COMPANIESGetAlternativeNames(company_id);
  }
  Companies.GetAlternativeNames = GetAlternativeNames;
  /********************
...
(function (Configuration) {
  ...
  Configuration.GetAPIConfiguration = GetAPIConfiguration;
  /********************
  ...
  Configuration.GetCountries = GetCountries;
  /********************
  ...
  Configuration.GetLanguages = GetLanguages;
  /********************
   ...
   ********************/
  function GetPrimaryTranslations() {
    return Validator.CONFIGURATIONGetPrimaryTranslations();
  }
  Configuration.GetPrimaryTranslations = GetPrimaryTranslations;
  /********************
  ...
  Configuration.GetTimezones = GetTimezones;
...
(function (Credits) {
   ...
   ********************/
  function GetDeatils(credit_id) {
    return Validator.CREDITSGetDetails(credit_id);
  }
  Credits.GetDeatils = GetDeatils;
})((Credits = exports.Credits || (exports.Credits = {})));
let Discover;
(function (Discover) {
  /********************
   ...
   ********************/
  function GetMovieDiscover(query) {
    return Validator.DISCOVERGetMovieDiscover(query);
  }
  Discover.GetMovieDiscover = GetMovieDiscover;
  /********************
   ...
   ********************/
  function GetTVDiscover(query) {
    return Validator.DISCOVERGetTVDiscover(query);
  }
  Discover.GetTVDiscover = GetTVDiscover;
})((Discover = exports.Discover || (exports.Discover = {})));
let Find;
(function (Find) {
  /********************
   ...
   ********************/
  function FindByID(external_id, language, external_source) {
    return Validator.FINDGetFindByID(external_id, language, external_source);
  }
  Find.FindByID = FindByID;
...
(function (Genres) {
   ...
   ********************/
  function GetMovieList(language) {
...
(function (GuestSessions) {
   ...
   ********************/
  function GetRatedMovies(guest_session_id, language, sort_by) {
  ...
  GuestSessions.GetRatedMovies = GetRatedMovies;
  /********************
   ...
   ********************/
  function GetRatedTVShows(guest_session_id, language, sort_by) {
  ...
  GuestSessions.GetRatedTVShows = GetRatedTVShows;
  /********************
   ...
   * @doc https://developers.themoviedb.org/3/guest-sessions/get-guest-session-rated-tv-shows
   ********************/
  function GetRatedTVEpisodes(guest_session_id, language, sort_by) {
  ...
  GuestSessions.GetRatedTVEpisodes = GetRatedTVEpisodes;
})((GuestSessions = exports.GuestSessions || (exports.GuestSessions = {})));
let KeyWords;
(function (KeyWords) {
  /********************
   ...
   ********************/
  function GetDetails(keyword_id) {
    return Validator.KETWORDSGetDetails(keyword_id);
  }
  KeyWords.GetDetails = GetDetails;
  /********************
   ...
   * @doc https://developers.themoviedb.org/3/keywords/get-keyword-details
   ********************/
  function GetMovies(keyword_id, language, include_adult) {
    return Validator.KETWORDSGetMovies(keyword_id, language, include_adult);
  }
  KeyWords.GetMovies = GetMovies;
...
(function (Lists) {
   ...
   ********************/
  function GetDetails(list_id, language) {
    return Validator.LISTSGetDetails(list_id, language);
  }
  Lists.GetDetails = GetDetails;
  /********************
   ...
   ********************/
  function GetCheckItemStatus(list_id, movie_id) {
    return Validator.LISTSGetCheckItemStatus(list_id, movie_id);
  }
  Lists.GetCheckItemStatus = GetCheckItemStatus;
  /********************
   * 3.Create a list.
   * @param {any} query
   ...
   ********************/
  function PostCreateList(query, session_id) {
    return Validator.LISTSPostCreateList(query, session_id);
  }
  Lists.PostCreateList = PostCreateList;
  /********************
   ...
   ********************/
  function PostAddMovie(query, list_id, session_id) {
    return Validator.LISTSPostAddMovie(query, list_id, session_id);
  }
  Lists.PostAddMovie = PostAddMovie;
  /********************
   ...
   ********************/
  function PostRemoveMovie(query, list_id, session_id) {
    return Validator.LISTSPostRemoveMovie(query, list_id, session_id);
  }
  Lists.PostRemoveMovie = PostRemoveMovie;
  /********************
   ...
   * @doc https://developers.themoviedb.org/3/lists/create-list
   ********************/
  function PostClearList(list_id, session_id, confirm) {
    return Validator.LISTSPostClearList(list_id, session_id, confirm);
  }
  Lists.PostClearList = PostClearList;
  /********************
   * 7.Delete  a list.
   * @param {number|string} list_id
   * @param {number|string} session_id
   ...
   ********************/
  function DeleteDeleteList(list_id, session_id) {
    return Validator.LISTSDeleteDeleteList(list_id, session_id);
  }
  Lists.DeleteDeleteList = DeleteDeleteList;
...
(function (Networks) {
   ...
   ********************/
  function GetDetails(network_id) {
    return Validator.NETWORKGetDetails(network_id);
  }
  Networks.GetDetails = GetDetails;
  /********************
   ...
   ********************/
  function GetAlternativeNames(network_id) {
    return Validator.NETWORKGetAlternativeNames(network_id);
  }
  Networks.GetAlternativeNames = GetAlternativeNames;
  /********************
   ...
   ********************/
  function GetImages(network_id) {
    return Validator.NETWORKGetImages(network_id);
  }
  Networks.GetImages = GetImages;
...
(function (People) {
   ...
   ********************/
  function GetDetails(person_id, language, append_to_response) {
    return Validator.PEOPLEGetDetails(person_id, language, append_to_response);
  }
  People.GetDetails = GetDetails;
  /********************
   ...
   ********************/
  function GetChanges(person_id, start_date, end_date, page) {
    return Validator.PEOPLEGetChanges(person_id, start_date, end_date, page);
  }
  People.GetChanges = GetChanges;
  /********************
   ...
   ********************/
  function GetMovieCredits(person_id, language) {
    return Validator.PEOPLEGetMovieCredits(person_id, language);
  }
  People.GetMovieCredits = GetMovieCredits;
  /********************
   ...
   ********************/
  function GetTVCredits(person_id, language) {
    return Validator.PEOPLEGetTVCredits(person_id, language);
  }
  People.GetTVCredits = GetTVCredits;
  /********************
   ...
   ********************/
  function GetCombinedCredits(person_id, language) {
    return Validator.PEOPLEGetCombinedCredits(person_id, language);
  }
  People.GetCombinedCredits = GetCombinedCredits;
  /********************
   ...
   ********************/
  function GetExternalIDs(person_id, language) {
    return Validator.PEOPLEGetExternalIDs(person_id, language);
  }
  People.GetExternalIDs = GetExternalIDs;
  /********************
   ...
   ********************/
  function GetImages(person_id) {
    return Validator.PEOPLEGetImages(person_id);
  }
  People.GetImages = GetImages;
  /********************
   ...
   ********************/
  function GetTaggedImages(person_id, language, page) {
    return Validator.PEOPLEGetTaggedImages(person_id, language, page);
  }
  People.GetTaggedImages = GetTaggedImages;
  /********************
   ...
   ********************/
  function GetTranslations(person_id, language) {
    return Validator.PEOPLEGetTranslations(person_id, language);
  }
  People.GetTranslations = GetTranslations;
  /********************
...
(function (Reviews) {
   ...
   ********************/
  function GetDeatils(review_id) {
    return Validator.REVIEWSGetDetails(review_id);
  }
  Reviews.GetDeatils = GetDeatils;
})((Reviews = exports.Reviews || (exports.Reviews = {})));
let Search;
(function (Search) {
  /********************
   ...
   ********************/
  function GetSearchCompanies(query, page) {
    return Validator.SEARCHGetSearchCompanies(query, page);
  }
  Search.GetSearchCompanies = GetSearchCompanies;
  /********************
   ...
   ********************/
  function GetSearchCollections(query, language, page) {
    return Validator.SEARCHGetSearchCollections(query, language, page);
  }
  Search.GetSearchCollections = GetSearchCollections;
  /********************
   ...
   ********************/
  function GetSearchKeywords(query, page) {
    return Validator.SEARCHGetSearchKeywords(query, page);
  }
  Search.GetSearchKeywords = GetSearchKeywords;
  /********************
   * 4.Search for movies.
   * @param {string} language(optional)
   * @param {string} query
   ...
   ********************/
  function GetMultiSearch(query, language, page, include_adult, region) {
   ...
   ********************/
  function GetSearchPeople(query, language, page, include_adult, region) {
  ...
  Search.GetSearchPeople = GetSearchPeople;
  /********************
  ...
  Search.GetSearchTVShows = GetSearchTVShows;
...
(function (TVseasons) {
   ...
   ********************/
  function GetDetails(tv_id, season_number, language, append_to_response) {
  ...
  TVseasons.GetDetails = GetDetails;
  /********************
  ...
  TVseasons.GetAccountStates = GetAccountStates;
  /********************
   ...
   ********************/
  function GetAggregateCredits(tv_id, season_number, language) {
  ...
  TVseasons.GetAggregateCredits = GetAggregateCredits;
  /********************
   ...
   ********************/
  function GetChanges(season_id, start_date, end_date, page) {
    return Validator.TVSEASONSGetChanges(season_id, start_date, end_date, page);
  }
  TVseasons.GetChanges = GetChanges;
  /********************
   ...
   ********************/
  function GetCredits(tv_id, season_number, language) {
    return Validator.TVSEASONSGetCredits(tv_id, season_number, language);
  }
  TVseasons.GetCredits = GetCredits;
  /********************
   ...
   * @doc https://developers.themoviedb.org/3/tv-seasons/get-tv-season-details
   ********************/
  function GetExternalIDs(tv_id, season_number, language) {
    return Validator.TVSEASONSGetExternalIDs(tv_id, season_number, language);
  }
  TVseasons.GetExternalIDs = GetExternalIDs;
  /********************
   ...
   ********************/
  function GetImages(tv_id, season_number, language) {
    return Validator.TVSEASONSGetImages(tv_id, season_number, language);
  }
  TVseasons.GetImages = GetImages;
  /********************
   ...
   ********************/
  function GetTranslations(tv_id, season_number, language) {
    return Validator.TVSEASONSGetTranslations(tv_id, season_number, language);
  }
  TVseasons.GetTranslations = GetTranslations;
  /********************
   ...
   ********************/
  function GetVideos(tv_id, season_number, language) {
    return Validator.TVSEASONSGetVideos(tv_id, season_number, language);
  }
  TVseasons.GetVideos = GetVideos;
})((TVseasons = exports.TVseasons || (exports.TVseasons = {})));
let TVEpisodes;
(function (TVEpisodes) {
  /********************
   * 1.Get the TV season details by id.
  ...
  TVEpisodes.GetDetails = GetDetails;
  /********************
  ...
  TVEpisodes.GetAccountStates = GetAccountStates;
  /********************
   ...
   ********************/
  function GetChanges(episode_id, start_date, end_date, page) {
  ...
  TVEpisodes.GetChanges = GetChanges;
  /********************
   ...
   ********************/
  function GetCredits(tv_id, season_number, episode_number, language) {
  ...
  TVEpisodes.GetCredits = GetCredits;
  /********************
   ...
   ********************/
  function GetExternalIDs(tv_id, season_number, episode_number) {
  ...
  TVEpisodes.GetExternalIDs = GetExternalIDs;
  /********************
   ...
   ********************/
  function GetImages(tv_id, season_number, episode_number) {
    return Validator.TVEPISODESGetImages(tv_id, season_number, episode_number);
  }
  TVEpisodes.GetImages = GetImages;
  /********************
   ...
   ********************/
  function GetTranslations(tv_id, season_number, episode_number) {
  ...
  TVEpisodes.GetTranslations = GetTranslations;
  /********************
   * 8.Rate a TV episode.
   * @param {number|string} tv_id
   * @param {number|string} season_number
  ...
  TVEpisodes.PostRateTVEpisode = PostRateTVEpisode;
  /********************
  ...
  TVEpisodes.DeleteDeleteRating = DeleteDeleteRating;
  /********************
   ...
   ********************/
  function GetVideos(tv_id, season_number, episode_number, language) {
  ...
  TVEpisodes.GetVideos = GetVideos;
})((TVEpisodes = exports.TVEpisodes || (exports.TVEpisodes = {})));
let TVepisodesgroups;
(function (TVepisodesgroups) {
  /********************
   ...
   ********************/
  function GetDeatils(id, language) {
    return Validator.TVEPISODESGROUPSGetDetails(id, language);
  }
  TVepisodesgroups.GetDeatils = GetDeatils;
})(
  (TVepisodesgroups =
    exports.TVepisodesgroups || (exports.TVepisodesgroups = {}))
);
let Watchproviders;
(function (Watchproviders) {
  ...
  Watchproviders.GetAvailableRegions = GetAvailableRegions;
  /********************
   ...
   ********************/
  function GetMovieProviders(language, watch_region) {
    return Validator.WATCHPROVIDERSGetMovieProviders(language, watch_region);
  }
  Watchproviders.GetMovieProviders = GetMovieProviders;
  /********************
   ...
   ********************/
  function GetTVProviders(language, watch_region) {
    return Validator.WATCHPROVIDERSGetTVProviders(language, watch_region);
  }
  Watchproviders.GetTVProviders = GetTVProviders;
})((Watchproviders = exports.Watchproviders || (exports.Watchproviders = {})));
//# sourceMappingURL=wrapTMDB.js.map
