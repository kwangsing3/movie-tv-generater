export declare class Lists {
     ...
     ********************/
    GetDetails(list_id: number | string, language?: string): Promise<any>;
    /********************
     ...
     ********************/
    GetCheckItemStatus(list_id: number | string, movie_id: number | string): Promise<any>;
    /********************
     * 3.POST /list
     ...
     ********************/
    PostCreateList(query: any, session_id: number | string): Promise<any>;
    /********************
     ...
     ********************/
    PostAddMovie(query: any, list_id: number | string, session_id: number | string): Promise<any>;
    /********************
     ...
     ********************/
    PostRemoveMovie(query: any, list_id: number | string, session_id: number | string): Promise<any>;
    /********************
     ...
     * @doc https://developers.themoviedb.org/3/lists/create-list
     ********************/
    PostClearList(list_id: number | string, session_id: number | string, confirm: boolean): Promise<any>;
    /********************
     ...
     ********************/
    DeleteDeleteList(list_id: number | string, session_id: number | string): Promise<any>;
}
