export declare class People {
     ...
     ********************/
    GetDetails(person_id: number | string, language?: string, append_to_response?: string): Promise<any>;
    /********************
     ...
     ********************/
    GetChanges(person_id: number | string, start_date?: string, end_date?: number | string, page?: number): Promise<any>;
    /********************
     ...
     ********************/
    GetMovieCredits(person_id: number | string, language?: string): Promise<any>;
    /********************
     ...
     ********************/
    GetTVCredits(person_id: number | string, language?: string): Promise<any>;
    /********************
     ...
     ********************/
    GetCombinedCredits(person_id: number | string, language?: string): Promise<any>;
    /********************
     ...
     ********************/
    GetExternalIDs(person_id: number | string, language?: string): Promise<any>;
    /********************
     ...
     ********************/
    GetImages(person_id: number | string): Promise<any>;
    /********************
     ...
     ********************/
    GetTaggedImages(person_id: number | string, language?: string, page?: number): Promise<any>;
    /********************
     ...
     ********************/
    GetTranslations(person_id: number | string, language?: string): Promise<any>;
    /********************
