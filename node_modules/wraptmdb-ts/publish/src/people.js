...
class People {
   ...
   ********************/
  async GetDetails(person_id, language, append_to_response) {
   ...
   ********************/
  async GetChanges(person_id, start_date, end_date, page) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetMovieCredits(person_id, language) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetTVCredits(person_id, language) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetCombinedCredits(person_id, language) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetExternalIDs(person_id, language) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetTaggedImages(person_id, language, page) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetTranslations(person_id, language) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
