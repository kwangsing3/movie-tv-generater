...
class Lists {
     ...
     ********************/
    async GetDetails(list_id, language) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL + c_module.Route.LIST + `${list_id}` + `?api_key=${token}`;
     ...
     ********************/
    async GetCheckItemStatus(list_id, movie_id) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
     ...
     ********************/
    async PostCreateList(query, session_id) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL + c_module.Route.LIST + `?api_key=${token}`;
     ...
     ********************/
    async PostAddMovie(query, list_id, session_id) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL +
            c_module.Route.LIST +
     ...
     ********************/
    async PostRemoveMovie(query, list_id, session_id) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL +
            c_module.Route.LIST +
     ...
     * @doc https://developers.themoviedb.org/3/lists/create-list
     ********************/
    async PostClearList(list_id, session_id, confirm) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL + c_module.Route.LIST + `${list_id}/clear` + `?api_key=${token}`;
        if (session_id !== '' && session_id !== undefined)
            targetURL += `&session_id=${session_id}`;
        ...
        const data = await axios.post(targetURL, {}, header);
        return data.data;
    }
    /********************
     ...
     ********************/
    async DeleteDeleteList(list_id, session_id) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL + c_module.Route.LIST + `${list_id}` + `?api_key=${token}`;
        if (session_id !== '' && session_id !== undefined)
