...
class TVseason {
   ...
   ********************/
  async GetDetails(tv_id, season_number, language, append_to_response) {
   ...
   ********************/
  async GetAggregateCredits(tv_id, season_number, language) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetChanges(season_id, start_date, end_date, page) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetCredits(tv_id, season_number, language) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   * @doc https://developers.themoviedb.org/3/tv-seasons/get-tv-season-details
   ********************/
  async GetExternalIDs(tv_id, season_number, language) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetImages(tv_id, season_number, language) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetTranslations(tv_id, season_number, language) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
   ...
   ********************/
  async GetVideos(tv_id, season_number, language) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL =
      baseURL +
