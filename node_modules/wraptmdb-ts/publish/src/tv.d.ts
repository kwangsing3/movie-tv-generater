export declare class TV {
     ...
     ********************/
    GetDetails(tv_id: number | string, language?: string): Promise<any>;
    /********************
     ...
     ********************/
    GetAccountStates(tv_id: number | string, session_id: string, guest_session_id?: string): Promise<any>;
    /********************
     ...
     ********************/
    GetAggregateCredits(tv_id: number | string, language?: string): Promise<any>;
    /********************
     ...
     ********************/
    GetAlternativetitles(tv_id: number | string, language?: string): Promise<any>;
    /********************
     ...
     ********************/
    GetChanges(tv_id: number | string, start_date?: string, end_date?: string, page?: number): Promise<any>;
    /********************
     ...
     ********************/
    GetContentRatings(tv_id: number | string, language?: string): Promise<any>;
    /********************
     ...
     ********************/
    GetCredits(tv_id: number | string, language?: string): Promise<any>;
    /********************
     ...
     ********************/
    GetEpisodeGroup(tv_id: number | string, language?: string): Promise<any>;
    /********************
     ...
     ********************/
    GetExternalIDs(tv_id: number | string, language?: string): Promise<any>;
    /********************
     ...
     ********************/
    GetImages(tv_id: number | string, language?: string): Promise<any>;
    /********************
     ...
     ********************/
    GetKeywords(tv_id: number | string): Promise<any>;
    /********************
     ...
     ********************/
    GetRecommendations(tv_id: number | string, language?: string, page?: number): Promise<any>;
    /********************
     ...
     ********************/
    GetReviews(tv_id: number | string, language?: string, page?: number): Promise<any>;
    /********************
     ...
     ********************/
    GetScreenedTheatrically(tv_id: number | string): Promise<any>;
    /********************
     ...
     ********************/
    GetSimilarTVShows(tv_id: number | string, language?: string, page?: number): Promise<any>;
    /********************
     ...
     ********************/
    GetTranslations(tv_id: number | string): Promise<any>;
    /********************
     ...
     ********************/
    GetVideos(tv_id: number | string, language?: string): Promise<any>;
    /********************
      ...
      ********************/
    GetWatchProviders(tv_id: number | string): Promise<any>;
    /********************
     ...
     * }
     ********************/
    PostRateTVShow(tv_id: number | string, query: any, session_id: string, guest_session_id?: string): Promise<any>;
    /********************
     ...
     ********************/
    DeleteRating(tv_id: number | string, session_id: string, guest_session_id?: string): Promise<any>;
    /********************
     * 21.GET /tv/latest
     ...
     ********************/
    GetLatest(language?: string): Promise<any>;
    /********************
     ...
     ********************/
    GetTVAiringToday(language?: string, page?: number): Promise<any>;
    /********************
     ...
     ********************/
    GetTVOnTheAir(language?: string, page?: number): Promise<any>;
    /********************
     * 24.GET /tv/popular
     ...
     ********************/
    GetPopular(language?: string, page?: number): Promise<any>;
    /********************
     * 25.GET /tv/top_rated
     ...
     ********************/
    GetTopRated(language?: string, page?: number): Promise<any>;
}
