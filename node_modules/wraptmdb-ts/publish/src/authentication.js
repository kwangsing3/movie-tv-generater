...
class Authentication {
   ...
   ********************/
  async PostCreateSessionWithLogin(query) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    const targetURL =
      baseURL +
   ...
   ********************/
  async DeleteDeleteSession(query) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    const targetURL =
    ...
    const data = await axios.delete(targetURL, query, header);
    return data.data;
  }
}
