 ...
 ********************/
export declare function Init(token: string | undefined): void;
/********************
 * Debug: get TOKEN
...
export declare namespace Movies {
     ...
     ********************/
    function GetAccountStates(movie_id: number | string, session_id: string, guest_session_id?: string): any;
    /********************
     ...
     ********************/
    function GetChanges(movie_id: string, start_date?: string, end_date?: string, page?: number): any;
    /********************
     ...
     ********************/
    function GetImage(movie_id: number | string, language?: string, include_image_language?: string): any;
    /********************
     ...
     ********************/
    function GetLists(movie_id: number | string, language?: string, page?: number): any;
    /********************
     *10.Get a list of recommended movies for a movie.
     * @param {number|string} movie_id  Movie ID in TMDB
     * @doc https://developers.themoviedb.org/3/movies/get-movie-recommendations
     ********************/
    function GetRecommendations(movie_id: number | string, language?: string, page?: number): any;
    /********************
     ...
     ********************/
    function GetReviews(movie_id: number | string, language?: string, page?: number): any;
    /********************
     ...
     ********************/
    function GetSimilar(movie_id: number | string, language?: string, page?: number): any;
    /********************
     ...
     *
     ********************/
    function DeleteRating(movie_id: number | string, session_id?: string, guest_session_id?: string): any;
    /********************
     * 19.GET /movie/latest
     ...
     * @doc https://developers.themoviedb.org/3/movies/get-latest-movie
     ********************/
    function GetNowPlaying(language?: string, page?: number, region?: string): any;
    /********************
...
export declare namespace TV {
     ...
     ********************/
    function GetAccountStates(tv_id: number | string, session_id: string, guest_session_id?: string): any;
    /********************
     ...
     ********************/
    function GetChanges(tv_id: number | string, start_date?: string, end_date?: string, page?: number): any;
    /********************
     ...
     ********************/
    function GetRecommendations(tv_id: number | string, language?: string, page?: number): any;
    /********************
     ...
     ********************/
    function GetReviews(tv_id: number | string, language?: string, page?: number): any;
    /********************
     ...
     * }
     ********************/
    function PostRateTVShow(tv_id: number | string, query: any, session_id: string, guest_session_id?: string): any;
    /********************
     ...
     ********************/
    function DeleteRating(tv_id: number | string, session_id: string, guest_session_id?: string): any;
    /********************
...
export declare namespace Account {
     ...
     ********************/
    function GetCreatedLists(account_id: string, session_id: string, language?: string, page?: number): any;
    /********************
     ...
     ********************/
    function GetFavoriteMovies(account_id: string, session_id: string, language?: string, sort_by?: string, page?: number): any;
    /********************
     ...
     ********************/
    function GetFavoriteTVShows(account_id: string, session_id: string, language?: string, sort_by?: string, page?: number): any;
    /********************
     ...
     ********************/
    function PostMarkAsFavorite(query: any, account_id: string, session_id: string): any;
    /********************
     ...
     ********************/
    function GetRatedMovies(account_id: string, session_id: string, language?: string, sort_by?: string, page?: number): any;
    /********************
     ...
     ********************/
    function GetRatedTVShows(account_id: string, session_id: string, language?: string, sort_by?: string, page?: number): any;
    /********************
     ...
     ********************/
    function GetRatedTVEpisodes(account_id: string, session_id: string, language?: string, sort_by?: string, page?: number): any;
    /********************
     ...
     ********************/
    function GetMovieWatchlist(account_id: string, session_id: string, language?: string, sort_by?: string, page?: number): any;
    /********************
     ...
     ********************/
    function GetTVShowWatchlist(account_id: string, session_id: string, language?: string, sort_by?: string, page?: number): any;
    /********************
     ...
     ********************/
    function PostAddToWatchlist(session_id: string, query: any, account_id?: String): any;
}
...
export declare namespace Changes {
     ...
     ********************/
    function GetMovieChangeList(start_date?: string, end_date?: string, page?: number): any;
    /********************
     ...
     * @doc https://developers.themoviedb.org/3/changes/get-person-change-list
     ********************/
    function GetTVChangeList(start_date?: string, end_date?: string, page?: number): any;
    /********************
     ...
     * @doc https://developers.themoviedb.org/3/changes/get-person-change-list
     ********************/
    function GetPersonChangeList(start_date?: string, end_date?: string, page?: number): any;
}
export declare namespace Collections {
     ...
     ********************/
    function GetTranslations(collection_id: string | number, language?: string): any;
}
...
export declare namespace Find {
     ...
     ********************/
    function FindByID(external_id: number | string, language?: string, external_source?: string): any;
}
...
export declare namespace GuestSessions {
     ...
     ********************/
    function GetRatedMovies(guest_session_id: string, language?: string, sort_by?: string): any;
    /********************
     ...
     ********************/
    function GetRatedTVShows(guest_session_id: string, language?: string, sort_by?: string): any;
    /********************
     ...
     * @doc https://developers.themoviedb.org/3/guest-sessions/get-guest-session-rated-tv-shows
     ********************/
    function GetRatedTVEpisodes(guest_session_id: string, language?: string, sort_by?: string): any;
}
export declare namespace KeyWords {
     ...
     * @doc https://developers.themoviedb.org/3/keywords/get-keyword-details
     ********************/
    function GetMovies(keyword_id: number | string, language?: string, include_adult?: boolean): any;
}
export declare namespace Lists {
     ...
     ********************/
    function GetCheckItemStatus(list_id: number | string, movie_id: number | string): any;
    /********************
     * 3.Create a list.
     * @param {any} query
     ...
     ********************/
    function PostAddMovie(query: any, list_id: number | string, session_id: number | string): any;
    /********************
     ...
     ********************/
    function PostRemoveMovie(query: any, list_id: number | string, session_id: number | string): any;
    /********************
     ...
     * @doc https://developers.themoviedb.org/3/lists/create-list
     ********************/
    function PostClearList(list_id: number | string, session_id: number | string, confirm: boolean): any;
    /********************
     * 7.Delete  a list.
     * @param {number|string} list_id
     * @param {number|string} session_id
     ...
     ********************/
    function DeleteDeleteList(list_id: number | string, session_id: number | string): any;
}
...
export declare namespace People {
     ...
     ********************/
    function GetDetails(person_id: number | string, language?: string, append_to_response?: string): any;
    /********************
     ...
     ********************/
    function GetChanges(person_id: number | string, start_date?: string, end_date?: number | string, page?: number): any;
    /********************
     ...
     ********************/
    function GetCombinedCredits(person_id: number | string, language?: string): any;
    /********************
     ...
     ********************/
    function GetTaggedImages(person_id: number | string, language?: string, page?: number): any;
    /********************
...
export declare namespace Search {
     ...
     ********************/
    function GetSearchCollections(query: string, language?: string, page?: number): any;
    /********************
     ...
     ********************/
    function GetSearchMovies(query: string, language?: string, page?: number, include_adult?: boolean, region?: string, year?: number, primary_release_year?: number): any;
    /********************
     ...
     ********************/
    function GetMultiSearch(query: string, language?: string, page?: number, include_adult?: boolean, region?: string): any;
    /********************
     * 6.Search for people.
     * @param {string} language(optional)
     * @param {string} query
     ...
     ********************/
    function GetSearchPeople(query: string, language?: string, page?: number, include_adult?: boolean, region?: string): any;
    /********************
     ...
     ********************/
    function GetSearchTVShows(query: string, language?: string, page?: number, include_adult?: boolean, first_air_date_year?: number): any;
}
export declare namespace TVseasons {
     ...
     ********************/
    function GetDetails(tv_id: number | string, season_number: number | string, language?: string, append_to_response?: string): any;
    /********************
     ...
     * @doc https://developers.themoviedb.org/3/tv-seasons/get-tv-season-details
     ********************/
    function GetAccountStates(tv_id: number | string, season_number: number | string, session_id: string, guest_session_id?: string, language?: string): any;
    /********************
     ...
     ********************/
    function GetAggregateCredits(tv_id: number | string, season_number: number | string, language?: string): any;
    /********************
     ...
     ********************/
    function GetChanges(season_id: number | string, start_date?: string, end_date?: string, page?: number): any;
    /********************
     ...
     ********************/
    function GetCredits(tv_id: number | string, season_number: number | string, language?: string): any;
    /********************
     ...
     * @doc https://developers.themoviedb.org/3/tv-seasons/get-tv-season-details
     ********************/
    function GetExternalIDs(tv_id: number | string, season_number: number | string, language?: string): any;
    /********************
     ...
     ********************/
    function GetImages(tv_id: number | string, season_number: number | string, language?: string): any;
    /********************
     ...
     ********************/
    function GetTranslations(tv_id: number | string, season_number: number | string, language?: string): any;
    /********************
     ...
     ********************/
    function GetVideos(tv_id: number | string, season_number: number | string, language?: string): any;
}
export declare namespace TVEpisodes {
     ...
     ********************/
    function GetDetails(tv_id: number | string, season_number: number | string, episode_number: number | string, language?: string, append_to_response?: string): any;
    /********************
     ...
     ********************/
    function GetAccountStates(tv_id: number | string, season_number: number | string, episode_number: number | string, session_id?: string, guest_session_id?: string): any;
    /********************
     ...
     ********************/
    function GetChanges(episode_id: number | string, start_date?: string, end_date?: string, page?: number): any;
    /********************
     ...
     ********************/
    function GetCredits(tv_id: number | string, season_number: number | string, episode_number: number | string, language?: string): any;
    /********************
     ...
     ********************/
    function GetExternalIDs(tv_id: number | string, season_number: number | string, episode_number: number | string): any;
    /********************
     ...
     ********************/
    function GetImages(tv_id: number | string, season_number: number | string, episode_number: number | string): any;
    /********************
     ...
     ********************/
    function GetTranslations(tv_id: number | string, season_number: number | string, episode_number: number | string): any;
    /********************
     * 8.Rate a TV episode.
     * @param {number|string} tv_id
     * @param {number|string} season_number
     ...
     ********************/
    function PostRateTVEpisode(tv_id: number | string, season_number: number | string, episode_number: number | string, query: any, session_id?: string, guest_session_id?: string): any;
    /********************
     ...
     ********************/
    function DeleteDeleteRating(tv_id: number | string, season_number: number | string, episode_number: number | string, session_id?: string, guest_session_id?: string): any;
    /********************
     ...
     ********************/
    function GetVideos(tv_id: number | string, season_number: number | string, episode_number: number | string, language?: string): any;
}
