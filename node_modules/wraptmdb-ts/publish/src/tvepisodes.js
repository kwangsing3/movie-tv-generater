...
class TVEpisodes {
     ...
     ********************/
    async GetDetails(tv_id, season_number, episode_number, language, append_to_response) {
     ...
     ********************/
    async GetAccountStates(tv_id, season_number, episode_number, guest_session_id, session_id) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL +
            c_module.Route.TV +
     ...
     ********************/
    async PostRateTVEpisode(tv_id, season_number, episode_number, query, session_id, guest_session_id) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL +
            c_module.Route.TV +
     ...
     ********************/
    async DeleteDeleteRating(tv_id, season_number, episode_number, session_id, guest_session_id) {
        const token = c_module.GetToken();
        const header = c_module.GetHeader();
        let targetURL = baseURL +
            c_module.Route.TV +
