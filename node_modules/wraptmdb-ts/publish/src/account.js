...
class Account {
   ...
   ********************/
  async GetCreatedLists(account_id, session_id, language, page) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL = baseURL + c_module.Route.ACCOUNT;
   ...
   ********************/
  async GetFavoriteMovies(account_id, session_id, language, sort_by, page) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL = baseURL + c_module.Route.ACCOUNT + `${account_id}/`;
   ...
   ********************/
  async GetFavoriteTVShows(account_id, session_id, language, sort_by, page) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL = baseURL + c_module.Route.ACCOUNT + `${account_id}/`;
   ...
   ********************/
  async PostMarkAsFavorite(query, account_id, session_id) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL = baseURL + c_module.Route.ACCOUNT + `${account_id}/`;
    targetURL += 'favorite';
   ...
   ********************/
  async GetRatedMovies(account_id, session_id, language, sort_by, page) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL = baseURL + c_module.Route.ACCOUNT + `${account_id}/`;
   ...
   ********************/
  async GetRatedTVShows(account_id, session_id, language, sort_by, page) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL = baseURL + c_module.Route.ACCOUNT + `${account_id}/`;
    targetURL += 'rated/' + 'tv';
   ...
   ********************/
  async GetRatedTVEpisodes(account_id, session_id, language, sort_by, page) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL = baseURL + c_module.Route.ACCOUNT + `${account_id}/`;
   ...
   ********************/
  async GetMovieWatchlist(account_id, session_id, language, sort_by, page) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL = baseURL + c_module.Route.ACCOUNT + `${account_id}/`;
   ...
   ********************/
  async GetTVShowWatchlist(account_id, session_id, language, sort_by, page) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL = baseURL + c_module.Route.ACCOUNT + `${account_id}/`;
   ...
   ********************/
  async PostAddToWatchlist(query, account_id, session_id) {
    const token = c_module.GetToken();
    const header = c_module.GetHeader();
    let targetURL = baseURL + c_module.Route.ACCOUNT;
    if (account_id !== '' && account_id !== undefined) {
